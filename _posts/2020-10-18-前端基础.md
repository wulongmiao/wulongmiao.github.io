...
align-content:多行的对齐 flex-start flex-end center space-around  space-between

align-items:flex-start flex-end center stretch baseline	
align-self设置具体的项目flex-start flex-end center stretch baseline	
...
全局：String(obj) parseInt() parseFloat() isNaN()数字返回false,非数true Number()  eval() escape()编码 unescape()解码 不会对数字，ascii编解码，不能用于URI decodeURI()解码 encodeURI()编码 
```
