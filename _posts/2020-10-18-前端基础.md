...
```
Object.assign(targrt,a,b...)a,b...复制到target
```
...
map 键名可定义为对象，不再局限于字符串 set() get() delete()
set对象 类数组对象，值不可重复，自动过滤重复元素
模块import from只读，对象可改 export default可不需要了解模块具体细节，默认加载，import可起任意名
