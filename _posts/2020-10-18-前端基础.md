...
Object:create(a,b)只能获得a本身的属性，不能读取a的原型 defineProperties(a,b)对象上定义新的属性，或者修改现有属性
Object.defineProperty(obj,prop,descriptor)  hasOwnProperty()是否具有指定的属性 A.isPrototypeOf(B)A是否存在于B的原型链上 
