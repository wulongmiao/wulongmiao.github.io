...
<div><a href="#sjjg" target="_self">2. 算法和手撕代码</a></div>
...
完全多路复用(解决了线程阻塞的问题)，使用报头压缩，
采用二进制协议，服务器推送，https协议
增加了基于UDP的QUIC协议
</pre>
...
typeof 和instance of
```
typeof：只能表示7种基本类型 number、boolean、string、function、object(null返回值)、undefined,symbol
