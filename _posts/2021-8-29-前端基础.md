...
相同patchVnode：newNode有子节点，old没有，将new添加到dom；old有，new无，删除真实dom子节点；都有文本节点，dom文本节点设置成new的文本节点；都有子节点，深度优先算法，双指针比对子节点，头节点相同，向后移，尾节点相同，向前移，不同则查找旧节点是否存在新节点的key，存在插入旧节点前，不存在新增
