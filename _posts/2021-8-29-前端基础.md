...
private static int[] mergeSort(int[] arr, int start, int end) {
        ...
        int[] arrLeft = mergeSort(arr,start,middle);
    ...
    private static int[] merge(int[] arrLeft, int[] arrRight) {
        int i=0,j=0,newArrIndex=0;
        int[] newArr = new int[arrLeft.length+arrRight.length];

        for(;i<arrLeft.length&&j<arrRight.length;) {
            if (arrLeft[i] < arrRight[j]) {
                newArr[newArrIndex++] = arrLeft[i];
                i++;
            }else {
                newArr[newArrIndex++] = arrRight[j];
                j++;
            }
        }
